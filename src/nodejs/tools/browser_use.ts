import { BrowserUseParamOld, BrowserUseResultOld } from '../../types/tools.types';
 ...
 */
export class BrowserUse implements Tool<BrowserUseParamOld, BrowserUseResultOld> {
  name: string;
  description: string;
...
* \`select_dropdown_option\`: Select dropdown option for interactive element index by the text of the option you want to select.`,
   ...
   */
  async execute(context: ExecutionContext, params: BrowserUseParamOld): Promise<BrowserUseResultOld> {
    try {
